...
/* import fonts */
import { cutiveMono, notoSerifTC } from "@/lib/font";
    ...
    return (
        <Typography variant="small"  >
            <Box sx={{ marginLeft: { xs: "0.9rem !important", md: "1.8rem !important" }, marginTop: { xs: "0.9rem !important", md: "unset !important" } }} >
                ...
                <Box component="span" className={notoSerifTC.className}>吳 宜 曄</Box>
            </Box>
        </Typography >
    );
}
...
export function SidebarFooter() {
    return (
        <>
            <Typography
                variant="caption"
                sx={{ m: "1.8rem", whiteSpace: 'nowrap', paddingBottom: "0.8rem !important" }}
